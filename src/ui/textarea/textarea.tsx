...
const Textarea = forwardRef<HTMLTextAreaElement, React.TextareaHTMLAttributes<HTMLTextAreaElement>>(
	({ className, ...props }, ref) => (
		<textarea
			className={twMerge(
				`data-[hasvalue=true]:!invalid:ring-2 flex  w-full resize-none rounded-xl border-0 bg-transparent p-4 text-base text-gray-800 !outline-0 ring-1 !ring-inset
				 ring-gray-300 transition-basic placeholder:text-gray-400 autofill:shadow-[0_0_0_30px_white_inset] read-only:pointer-events-none
