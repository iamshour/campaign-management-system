...
interface createPrebuiltTemplateDialogProps {
	/**
...
const CreatePrebuiltTemplateDialog = ({ children }: createPrebuiltTemplateDialogProps) => {
...
export default CreatePrebuiltTemplateDialog
