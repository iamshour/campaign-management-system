...
const ChannelSourceListingBulkSchema = z.object({
	basicInfo: channelSourceRequestBasicInfoSchema.omit({ email: true, sender: true }),
...
export default ChannelSourceListingBulkSchema

export type ChannelSourceListingBulkSchemaType = z.infer<typeof ChannelSourceListingBulkSchema>
