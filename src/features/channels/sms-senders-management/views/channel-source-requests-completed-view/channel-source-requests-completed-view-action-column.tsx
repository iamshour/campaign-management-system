...
const ChannelSourceRequestsCompletedViewActionColumn = ({ action }: { action: ChannelSourceRequestAction }) => {
...
export default ChannelSourceRequestsCompletedViewActionColumn
