...
const InputWithSearch = forwardRef<React.ElementRef<typeof Popover.Trigger>, InputWithSearchProps>(
	({ contentProps, fetchState: { setShouldFetch, suggestions }, onChange, readOnly, value, ...props }, ref) => {
